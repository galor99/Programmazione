...
class FooTest : public ::testing::Test {
 protected:
  ...
  FooTest() {
     // You can do set-up work for each googleTest here.
  }
  ...
  // and cleaning up each googleTest, you can define the following methods:

  void SetUp() override {
     // Code here will be called immediately after the constructor (right
     // before each googleTest).
  }

  void TearDown() override {
     // Code here will be called immediately after each googleTest (right
     // before the destructor).
  }

  // Class members declared here can be used by all tests in the googleTest suite
  // for Foo.
};
